                        ...
                        <div className="mt-12 flex flex-col items-center">
                            ...
                            <div className="w-full flex-1 mt-8">
                                <div className="flex flex-col items-center">
                                    <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-pink text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
                                    ...
                                    <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-pink text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                                        ...
                                        <span className="ml-4" onClick={() => signIn('github')}>
                                            Sign In with GitHub
                                        </span>
                                    </button>
                                </div>
                                ...
                                <form onSubmit={formik.handleSubmit} action="/api/auth/callback/credentials">
                                    <div className="mx-auto max-w-xs">
                                        ...
                                        {(formik.errors.password && formik.touched.password) ?
                                            ...
                                            : ''}
                                        <button type="submit" className="mt-5 tracking-wide font-semibold bg-pink text-gray-100 w-full py-4 rounded-lg hover:bg-pink-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                                        ...
                                        <p className="mt-6 text-xs text-gray-600 text-center">
                                            ...
                                            <Link href="/auth/register" className="flex items-center justify-center gap-3  text-lg">
                                                <span>Register first</span> <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd"><path d="M21.883 12l-7.527 6.235.644.765 9-7.521-9-7.479-.645.764 7.529 6.236h-21.884v1h21.883z" /></svg>
                                            </Link>
                                        </p>
                                    </div>
                                </form>
